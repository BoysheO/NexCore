...
namespace UISystem.Implements.UIContainers
{
    ...
    /// </summary>
    public sealed class WindowUIContainer : MonoBehaviour, IUIContainer
    {
        private const bool IsDEBUG = BuildInConstConfig.IsDebug;
        private MaskObj _maskObj;

        [ShowInInspector] private IReadOnlyList<IUIContainerItem> Stack => _uiStack.InternalBuffer;
        [ShowInInspector] private IReadOnlyList<IUIContainerItem> List => _uiList.InternalBuffer;

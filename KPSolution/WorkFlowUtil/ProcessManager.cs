...
namespace Boysheo.ProcessSystem
{
    ...
    public class ProcessManager
    {
        ...
        public static async Task Chmod777(string file)
        {
            await BaseInvokeAsync("chmod", $"777 \"{file}\"", null, NullLogger.Instance, NullLogger.Instance);
        }
        ...
        public static bool IsExecutable(string file)
        {
            ...
            // 检查是否具有执行权限
            bool isExecutable = (attributes & FileAttributes.Normal) != 0;
            return isExecutable;
        }
    }
}